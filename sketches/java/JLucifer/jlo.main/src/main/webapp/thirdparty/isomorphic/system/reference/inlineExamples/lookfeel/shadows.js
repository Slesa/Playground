...
isc.Label.create({
    ID:"textBox",
    left:160, top:20, width:240, padding:10,
...
isc.Slider.create({
    minValue:1, maxValue:10, numValues:11, showRange:false, labelWidth:20,
    title:"Softness", value:10,
    valueChanged: "textBox.shadowSoftness = value; textBox.updateShadow();"
})

isc.Slider.create({
    minValue:0, maxValue:20, numValues:21, showRange:false, labelWidth:20,
    title:"Offset", left:60, value:5,
