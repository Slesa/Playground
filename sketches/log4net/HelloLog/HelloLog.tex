...
\lstset{language=C++, tabsize=2, backgroundcolor=\color{darkgray}, showstringspaces=false}
...
Ein weiterer Parameter names \emph{Watch} gibt an, ob die Konfigurationsdatei auf Änderungen hin überwacht werden soll:
...
zur formatieren Ausgabe von Text - \emph{DebugFormat}, \emph{InfoFormat}, \emph{WarnFormat}, \emph{ErrorFormat}:
...
den Default-Level erstmal auf \emph{Warn}:
