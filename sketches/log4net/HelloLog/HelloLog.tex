...
\section{Prolog}
Der nachfolgende Text umfaßt einen Schnelleinstieg in die Konfiguration von Log4net. Das Beispiel-Projekt steht auf 
\url{https://github.com/Slesa/Playground/tree/master/sketches/log4net/HelloLog} zur Verfügung.
...
nicht auf \emph{SimpleLayout} gesetzt, sondern explizit per \emph{Patternlayout} angegeben:
...
\section{Log pro Klasse}
Das global eingestellte Log-Verhalten kann pro Klasse überschrieben werden. Damit ist es möglich, nur bestimmte Klassen
bzw deren Methoden zu protokollieren, oder auch nur diese Log-Nachrichten auf anderen Appendern auszugeben.\\
...
In diesem Beispiel werden alle Log-Nachrichten der Stufe \emph{Warn} auf der Konsole ausgegeben, für die Klasse HelloLog.Foo 
allerdings werden alle Nachrichten ausgegeben, zusätzlich werden diese Nachrichten noch farbig auf der Konsole ausgegeben.\\
\medskip
...
gilt oben beschriebenes Verhalten für alle Klassen im Namensraum \emph{HelloLog}.
...
Hinweis: es wurden beileibe nicht alle Möglichkeiten von Log4net aufgezeigt. ZB bestehen diverse Filter-Möglichkeiten bei
der Weiterleitung der Log-Events. Weiterführende Informationen finden sich auf der Seite 
\url{http://logging.apache.org/log4net/release/sdk/}
