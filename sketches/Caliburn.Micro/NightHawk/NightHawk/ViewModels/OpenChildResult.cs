...
namespace NightHawk.ViewModels
{
    ...
    {
        Func<ActionExecutionContext, IConductor> _locateParent;
        Action<TChild> _onConfigure;

        readonly Func<ActionExecutionContext, TChild> _locateChild = c => IoC.Get<TChild>();
