...
namespace MediaOwl.ViewModels
{
    ...
    public class MusicViewModel : Conductor<IScreen>.Collection.OneActive
    {
        #region Constructor
        [ImportingConstructor]
        public MusicViewModel([ImportMany(AllowRecomposition = true)] IEnumerable<IChildScreen<MusicViewModel>> childScreens)
        {
            DisplayName = AppStrings.MusicTitle;
